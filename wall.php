			...
			<div class="inner_content">
                ...
                <div id="options">
                    <ul id="filters" class="option-set" data-option-key="filter">
                        ...
                        <?php
                        $subTypeQuery = mysql_query("SELECT DISTINCT sub_type FROM products WHERE type = 2 AND status = 1");
                        while ($row = mysql_fetch_array($subTypeQuery)) {
                            echo '<li><a href="#filter" data-option-value=".category'.$row[0].'">'.$GLOBALS['SUB_CATEGORY'][2][$row[0]].'</a></li>';
                        }
                        ?>
                    </ul>
                    <div class="clear"></div>
