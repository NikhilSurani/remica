...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="delete.php"><svg class="glyph stroked trash"><use xlink:href="#stroked-trash"></use></svg> Delete Item</a></li>
		</ul>
				...
				<div class="panel panel-default">
					<div class="panel-body tabs">
						...
						<ul class="nav nav-pills">
							...
							<li><a href="#pilltab4" data-toggle="tab">Home Img</a></li>
							<!--li><a href="#pilltab4" data-toggle="tab">Home Img</a></li-->
						</ul>
						...
						<div class="tab-content">
							<div class="tab-pane fade in active" id="pilltab1">
								...
								<?php
									...
									while ($res = mysql_fetch_array($que))
									{
										...
										echo "<td><a href='delete1.php?type=j&id=".$res[id]."'>Delete</a></td></tr>";
									}
								?></tbody>
								</table>
							</div>
							...
							<div class="tab-pane fade" id="pilltab2">
								...
								<?php
									...
									while ($res1 = mysql_fetch_array($que1))
									{
										...
										echo "<td><a href='delete1.php?type=c&id=".$res1[id]."'>Delete</a></td></tr>";
									}
								?></tbody>
								</table>
							</div>
							<div class="tab-pane fade" id="pilltab4">
								...
								<?php
									...
									while ($res1 = mysql_fetch_array($que1))
									{
										echo "<tr scope='row'><td width='10%'>".$res1['id']."</td><td width='20%'>".$res1['h_name']."</td><td width='30%'><img height='50%' width='30%' class='img-responsive' src='images/h_img/".$res1['h_img']."'/></td>";
										echo "<td><a href='delete1.php?type=h&id=".$res1[id]."'>Delete</a></td></tr>";
									}
								?></tbody>
								</table>
							</div>
