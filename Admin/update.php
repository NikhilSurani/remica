						...
						<div class="tab-content">
							<div class="tab-pane fade in active" id="pilltab1">
								...
								<?php 								
									...
									{
										echo "<tr scope='row'><td width='10%'>".$i."</td><td width='20%'>".$GLOBALS['MAIN_CATEGORY'] [$res['type']]."</td><td width='20%'>".$GLOBALS['SUB_CATEGORY'][$res['type']][$res['sub_type']]."</td><td width='20%'>".$res['image_title']."</td><td width='30%'><img height='50%' width='30%' class='img-responsive' src='../img/portfolio/".$res['img_origional_name']."'/></td>";										
										echo "<td><a href='edit.php?type=j&id=".$res[id]."'>Edit</a></td>";
										echo "</tr>";
										$i++;	
									}
									if(empty($res)) {
							...
							<div class="tab-pane fade" id="pilltab2">
								...
								<tbody>
								<?php
									$que1 = mysql_query("SELECT * FROM products where type=2");
									$i = 1;
									...
									while ($res1 = mysql_fetch_array($que1))
									{
										...
										echo "<tr scope='row'><td width='10%'>".$i."</td><td width='20%'>".$GLOBALS['MAIN_CATEGORY'] [$res['type']]."</td><td width='20%'>".$GLOBALS['SUB_CATEGORY'][$res['type']][$res['sub_type']]."</td><td width='20%'>".$res['image_title']."</td><td width='30%'><img height='50%' width='30%' class='img-responsive' src='../img/portfolio/".$res['img_origional_name']."'/></td>";
										echo "<td><a href='edit2.php?type=c&id=".$res1[id]."'>Edit</a></td>";										
										echo "</tr>";
										$i++;	
									}
									if(empty($res1)) {
