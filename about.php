...
<!--col 3-->					
		...
		<h2>Our Process</h2>
			...
			<div class="testimonial3 fadeinup">
				<p>
					...
					Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Suspendisse potenti. Vivamus purus arcu, commodo cursus egestas et, 
					dictum lobortis dui. Curabitur at mi eu mi sollicitudin faucibus at at libero. Praesent vestibulum molestie lacus. Aenean hendrerit mauris. Phasellus porta. 
					Fusce taciti sociosqu ad litora suscipit varius mi Vivamus purus arcu, commodo cursus egestas et dictum.
				</p> 
			</div>
		...
		<!--5-->
			...
			<div class="testimonial1 fadeinup">
				<p>
					...
					Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Suspendisse potenti. Vivamus purus arcu, commodo cursus egestas et, 
					dictum lobortis dui. Curabitur at mi eu mi sollicitudin faucibus at at libero. Praesent vestibulum molestie lacus. Aenean hendrerit mauris. Phasellus porta. 
					Fusce taciti sociosqu ad litora suscipit varius mi. Vivamus purus arcu.
				</p>
			</div>
				<p class="center"><small>QUOTE AUTHOR</small><br/><span class="hue">Company</span></p>
			<div class="pad15"></div> -->
	...
	<!-- <div class="col-sm-6 col-md-4">
		<div class="team_sections fadeindown">
			...
			<h5>
				<span>Kishorbhai Shah</span>
			</h5>
			<p>
				<small class="muted">- FOUNDER & CEO- </small>				
			</p>
			<p class="team_bio">
